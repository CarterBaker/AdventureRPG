...
public class FileParserUtility {
    ...
    public static String convertFileToRawText(File file) {
    ...
    public static ObjectArrayList<String> convertRawTextToArray(String rawText) {
    ...
    public static String stripCommentsFromText(String text) {
    ...
    public static boolean lineStartsWith(String line, String token) {
    ...
    public static int countCharInString(String str, char target) {
    ...
    public static int findLastTypeDelimiter(String declaration) {
    ...
    public static String extractPayloadAfterToken(String line, String token) {
