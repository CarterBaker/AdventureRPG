...
public class StaticModelDataInstance extends ModelDataInstance {
    ...
    StaticModelDataInstance(int modelID) {
        ...
        this.vertStride = EngineSetting.STATIC_VERT_STRIDE;
        this.floatsPerQuad = vertStride * 4;
    ...
    public void merge(StaticModelDataInstance other) {
    ...
    private boolean tryMergeCompleteMesh(int materialId, MeshDataInstance sourceMesh) {
        ...
        if (sourceMesh.getVertexCount() <= EngineSetting.MESH_VERT_LIMIT) {
            MeshDataInstance newMesh = (MeshDataInstance) create(new MeshDataInstance(vertStride));
