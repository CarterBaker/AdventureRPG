...
public class ModelBatchSystem extends SystemFrame {
    ...
    void pushModelData(int vao, StaticModelDataInstance modelData) {
        ...
        for (var entry : meshCollections.int2ObjectEntrySet()) {
            ...
            for (MeshDataInstance meshData : meshList) {
                ...
                MeshHandle meshHandle = GLSLUtility.uploadMeshData(vao, vertices, indices);
    ...
    void pullModelData(StaticModelDataInstance modelData) {
