package com.AdventureRPG.core.renderer.rendersystem;

import com.AdventureRPG.core.engine.SystemFrame;
import com.AdventureRPG.core.geometry.Models.ModelHandle;
...
public class RenderSystem extends SystemFrame {
    ...
    public void draw() {
        ...
        GLSLUtility.setViewport(
                gameEngine.getScreenWidth(),
                gameEngine.getScreenHeight());
