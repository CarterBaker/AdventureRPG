...
public final class Vector4Uniform extends UniformAttributeStruct<Object> {
    ...
    protected void push(int handle, Object value) {
        if (value instanceof com.internal.platform.math.Vector4 gdxVector)
            ...
            throw new IllegalArgumentException(
                    "push(int, Vector4): Expected Vector4 or com.internal.platform.math.Vector4, got " + value.getClass());
    }
    ...
    protected void applyValue(Object value) {
        if (value instanceof com.internal.platform.math.Vector4 gdxVector)
            ...
            throw new IllegalArgumentException(
                    "applyValue(Vector4): Expected Vector4 or com.internal.platform.math.Vector4, got " + value.getClass());
    }
}