...
public final class Vector2Uniform extends UniformAttributeStruct<Object> {
    ...
    protected void push(int handle, Object value) {
        if (value instanceof com.internal.platform.math.Vector2 gdxVector)
            ...
            throw new IllegalArgumentException(
                    "push(int, Vector2): Expected Vector2 or com.internal.platform.math.Vector2, got " + value.getClass());
    }
    ...
    protected void applyValue(Object value) {
        if (value instanceof com.internal.platform.math.Vector2 gdxVector)
            ...
            throw new IllegalArgumentException(
                    "applyValue(Vector2): Expected Vector2 or com.internal.platform.math.Vector2, got " + value.getClass());
    }
}