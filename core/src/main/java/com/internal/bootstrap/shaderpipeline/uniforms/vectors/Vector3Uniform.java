...
public final class Vector3Uniform extends UniformAttributeStruct<Object> {
    ...
    protected void push(int handle, Object value) {
        if (value instanceof com.internal.platform.math.Vector3 gdxVector)
            ...
            throw new IllegalArgumentException(
                    "push(int, Vector3): Expected Vector3 or com.internal.platform.math.Vector3, got " + value.getClass());
    }
    ...
    protected void applyValue(Object value) {
        if (value instanceof com.internal.platform.math.Vector3 gdxVector)
            ...
            throw new IllegalArgumentException(
                    "applyValue(Vector3): Expected Vector3 or com.internal.platform.math.Vector3, got " + value.getClass());
    }
}