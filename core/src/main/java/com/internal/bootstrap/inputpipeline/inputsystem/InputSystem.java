...
public class InputSystem extends SystemPackage implements InputProcessor {
    ...
    protected void start() {
        PlatformRuntime.input.setInputProcessor(this);
    }
    ...
    protected void update() {
        ...
        float deltaX = PlatformRuntime.input.getDeltaX() * sensitivity;
        float deltaY = PlatformRuntime.input.getDeltaY() * sensitivity;
    ...
    public void captureCursor(boolean captured) {
        PlatformRuntime.input.setCursorCatched(captured);
    }
