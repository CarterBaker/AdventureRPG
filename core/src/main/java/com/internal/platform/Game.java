...
public abstract class Game implements ApplicationListener {
    ...
    public void setScreen(Screen screen) {
        ...
        if (screen != null) {
            screen.show();
            if (PlatformRuntime.graphics != null) screen.resize(PlatformRuntime.graphics.getWidth(), PlatformRuntime.graphics.getHeight());
        }
    }
    ...
    @Override
    public void render() {
        if (screen != null && PlatformRuntime.graphics != null) screen.render(PlatformRuntime.graphics.getDeltaTime());
    }
