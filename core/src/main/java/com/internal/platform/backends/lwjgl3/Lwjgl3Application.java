...
public class Lwjgl3Application implements Application {
    ...
    public Lwjgl3Application(ApplicationListener listener, Lwjgl3ApplicationConfiguration config) {
        ...
        PlatformRuntime.app = this;
        PlatformRuntime.graphics = graphics;
        PlatformRuntime.input = input;
        Lwjgl3GL gl = new Lwjgl3GL();
        PlatformRuntime.gl = gl;
        PlatformRuntime.gl20 = gl;
        PlatformRuntime.gl30 = gl;
