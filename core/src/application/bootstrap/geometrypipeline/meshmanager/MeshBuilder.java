...
class MeshBuilder extends BuilderPackage {
     ...
     * A mesh declaring a "subvoxels" block carries no vertex data at all —
     * its geometry is generated by SubVoxelManager, the same path editor
     * tools use live, and it may not also declare quads or a rig.
