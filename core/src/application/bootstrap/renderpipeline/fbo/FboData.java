...
public class FboData extends DataPackage {
     ...
     *
     * resolveBlit marks targets whose content is jittered per pixel
     * (raymarched passes); the blit averages each 3x3 block of source texels
     * so the jitter resolves into a smooth result instead of a visible dither.
     *
