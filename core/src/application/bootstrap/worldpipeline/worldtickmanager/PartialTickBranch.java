...
public class PartialTickBranch extends BranchPackage {
    ...
    /*
     * Dedicated execution path PARTIAL-geometry blocks tick through. Owns
    ...
    protected void create() {
        ...
        // Settings
        this.intervalFrames = EngineSetting.PARTIAL_TICK_INTERVAL_FRAMES;

        // State
        this.frameCounter = EngineSetting.PARTIAL_TICK_PHASE_FRAMES;
    }
