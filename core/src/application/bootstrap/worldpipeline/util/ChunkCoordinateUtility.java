...
public class ChunkCoordinateUtility extends EngineUtility {

    /*
     * Precomputed block coordinate tables for one chunk, packed four bits per
     * axis in Y-Z-X order, with interior-only coordinates and neighbor lookups
     * used by geometry and simulation loops.
     */
    ...
    // Get the neighbor next to a coordinate using the `VertBlockNeighbor3Vector`
