...
import application.editor.runtime.RuntimeContext;
...
public class EditorEngine extends EnginePackage {
    ...
    private application.editor.bootstrap.BootstrapAssembly editorBootstrapAssembly;
    ...
    protected void bootstrap() {
        ...
        this.editorBootstrapAssembly = create(application.editor.bootstrap.BootstrapAssembly.class);
    }
