...
public class Color extends EngineUtility {
    ...
    public application.core.util.mathematics.extras.Color toNative() {
        return new application.core.util.mathematics.extras.Color(r, g, b, a);
    }

    public Color fromNative(application.core.util.mathematics.extras.Color other) {
