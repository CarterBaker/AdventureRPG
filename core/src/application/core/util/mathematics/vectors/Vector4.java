package application.core.util.mathematics.vectors;
...
public class Vector4 extends EngineUtility {
    ...
    public application.core.util.mathematics.vectors.Vector4 toNative() {
        return new application.core.util.mathematics.vectors.Vector4(x, y, z, w);
    }

    public Vector4 fromNative(application.core.util.mathematics.vectors.Vector4 other) {
