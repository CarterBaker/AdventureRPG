...
public class Vector3 extends EngineUtility {
    ...
    public application.core.util.mathematics.vectors.Vector3 toNative() {
        return new application.core.util.mathematics.vectors.Vector3(x, y, z);
    }

    public Vector3 fromNative(application.core.util.mathematics.vectors.Vector3 other) {
