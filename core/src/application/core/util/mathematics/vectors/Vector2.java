...
public class Vector2 extends EngineUtility {
    ...
    public application.core.util.mathematics.vectors.Vector2 toNative() {
        return new application.core.util.mathematics.vectors.Vector2(x, y);
    }

    public Vector2 fromNative(application.core.util.mathematics.vectors.Vector2 other) {
