...
public interface GL20 {
    ...
    void glTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format,
            int type, Buffer pixels);
    ...
    void glUniform1iv(int loc, IntBuffer value);

    void glUniform1fv(int loc, FloatBuffer value);

    void glUniform2iv(int loc, IntBuffer value);

    void glUniform2fv(int loc, FloatBuffer value);

    void glUniform3iv(int loc, IntBuffer value);

    void glUniform3fv(int loc, FloatBuffer value);

    void glUniform4iv(int loc, IntBuffer value);

    void glUniform4fv(int loc, FloatBuffer value);
