...
public class Matrix2Double extends EngineUtility {

    /*
     * Mutable 2x2 double matrix with in-place operations.
     */
    ...
    public Matrix2Double add(Matrix2Double other) {
        return add(other.val[0], other.val[2],
    ...
    public Matrix2Double subtract(Matrix2Double other) {
        return subtract(other.val[0], other.val[2],
                other.val[1], other.val[3]);
    }
    ...
    public Matrix2Double multiply(
        ...
        val[0] = a00 * m00 + a01 * m10;
        val[1] = a10 * m00 + a11 * m10;
        val[2] = a00 * m01 + a01 * m11;
        val[3] = a10 * m01 + a11 * m11;

        return this;
    }

    public Matrix2Double multiply(double scalar) {
        return multiply(scalar, 0,
                0, scalar);
    }

    public Matrix2Double multiply(Matrix2Double other) {
        return multiply(other.val[0], other.val[2],
                other.val[1], other.val[3]);
    }
    ...
    public Matrix2Double divide(
        ...
        return multiply(m11 * invDet, -m01 * invDet,
    ...
    public Matrix2Double divide(double scalar) {
        ...
        return multiply(1.0 / scalar, 0,
                0, 1.0 / scalar);
    }

    public Matrix2Double divide(Matrix2Double other) {
        return divide(other.val[0], other.val[2],
                other.val[1], other.val[3]);
    }
