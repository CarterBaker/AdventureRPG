...
public final class Keys {
    ...
    public static final int SHIFT_RIGHT = GLFW.GLFW_KEY_RIGHT_SHIFT;
    ...
    public static final int ALT_RIGHT = GLFW.GLFW_KEY_RIGHT_ALT;
    public static final int SUPER_LEFT = GLFW.GLFW_KEY_LEFT_SUPER;
    public static final int SUPER_RIGHT = GLFW.GLFW_KEY_RIGHT_SUPER;
    ...
    public static final int BRACKET_LEFT = GLFW.GLFW_KEY_LEFT_BRACKET;
    public static final int BRACKET_RIGHT = GLFW.GLFW_KEY_RIGHT_BRACKET;
    ...
    public static final int GRAVE = GLFW.GLFW_KEY_GRAVE_ACCENT;
